...
class QrKeyboardService : InputMethodService(), LifecycleOwner {
     ...
     *  - Dong 2: 4, 5, 6, ABC (kich thuoc = 1 nut, dung ngay duoi nut Xoa).
     *    SUA (theo yeu cau nguoi dung): ABC TRUOC DAY nam o dong 4, da
     *    CHUYEN LEN dong nay, thay the dung vao vi tri khoang trong (spacer)
     *    truoc day cua dong 2, nam ben phai so 6.
     ...
     *  - Dong 4: chi con lai nut "0" (ABC va Enter da chuyen len dong 2/3 o
     *    tren) - "0" van dung nguyen cot cu cua no (cot 2), 2 cot con lai
     *    (cot 1 thay ABC cu, cot 3-4 thay Enter cu) deu la khoang trong.
    ...
    private fun buildExtendedSymbolsBottomRow(): LinearLayout {
        ...
        // SUA (theo yeu cau nguoi dung: "trang 3 doi vi tri 2 phim 'QR' va
        // '123' cho nhau"): "123" gio nam TRUOC (ben trai, cham ABC), "QR"
        // nam SAU (ben phai, gan phim cach) - dao vi tri cho nhau so voi
        // truoc, van GIU NGUYEN chuc nang cua tung nut.
    ...
    private fun buildKey(
        ...
        // SUA (theo yeu cau nguoi dung: "nut go chu in va nut enter deu
        // dung co vien voi do day tuong tu cac phim khac" + sau do "sua cho
        // nut qr luon"): TRUOC DAY co "highlight" (Enter, Shift dang bat,
        // nut QR) LUON dung VIEN DAY HON (borderWidthDp = 9) de de phan
        // biet - GIO DAY: bo han su khac biet nay, TAT CA cac phim (ke ca
        // Enter/Shift dang bat/QR) DUNG CHUNG 1 do day vien mac dinh
        // (buildGlowKeyBackground(), hien la 3dp) - hoan toan dong nhat,
        // khong con phim nao "noi bat" hon ve do day vien tren toan bo ban
        // phim nua.
