...
object LanguagePrefs {
     ...
     *  SUA (theo yeu cau nguoi dung: \"xoa het ngon ngu khac chi chua lai
     *  tieng viet va tieng anh\"): XOA HAN cac ngon ngu Phap/Tay Ban Nha/
     *  Duc/Bo Dao Nha/Y/Indonesia/Ma Lai/Tho Nhi Ky truoc day - CHi con
     *  DUNG 2 ngon ngu Tieng Viet + Tieng Anh. */
     ...
     *
     *  SUA (theo yeu cau nguoi dung: "xoa het ngon ngu khac chi chua lai
     *  tieng viet va tieng anh"): TRUOC DAY co du lieu rieng cho Phap/Tay
     *  Ban Nha/Duc/Bo Dao Nha/Y/Tho Nhi Ky - nhung CA 8 ngon ngu do da bi
     *  XOA khoi [SUPPORTED_LANGUAGES] o tren, nen bang nay KHONG CON DUOC
     *  DUNG TOI NUA (activeLangCode gio chi co the la "vi" hoac "en" - ma
     *  "vi" da co bo go Telex rieng day du hon nhieu, con "en" khong can
     *  dau phu) - de RONG thay vi giu du lieu chet khong con y nghia gi. */
    val ACCENT_VARIANTS: Map<String, Map<Char, List<Char>>> = emptyMap()
